...
Объём времени на выполнение задачи 5 минут:
- 1 минтуа на анализ логики построения задачи;
- 4 минуты сформировать запрос, оценить результаты и исправить исходный код при выявлении ошибки. 
